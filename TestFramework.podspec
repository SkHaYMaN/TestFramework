...
DESC
  ...
  s.homepage         = 'https://github.com/skhayman/TestFramework'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'TestFramework' => 'alexandre.soler@lyra-network.com' }
  s.source           = { :git => 'https://github.com/skhayman/TestFramework.git', :tag => s.version.to_s }
